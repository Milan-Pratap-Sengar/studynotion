...
export default function UploadContent({ name,label,register,setValue,errors,video = false,viewData = null,editData = null,}) {
  ...
  return (
    <div className="flex flex-col space-y-2">
      ...
      <div {...getRootProps()} className={`${ isDragActive ? "bg-richblack-600" : "bg-richblack-700" } flex min-h-[250px] cursor-pointer items-center justify-center rounded-md border-2 border-dotted border-richblack-500`} >
          ...
          (
            <div className="flex w-full flex-col p-6">
              ...
              }
              {
                !viewData && 
                (
                  <button type="button" className="mt-3 text-richblack-400 underline"  onClick={() => { setPreviewSource("") 
