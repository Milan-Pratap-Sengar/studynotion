...
export default function CourseDetails(){
    ...
    // It will fetch all the details of a perticular course
    useEffect(()=>{
        getCourseDetails()
    },[courseId])
    ...
    // It will calculate the avg rating of of the course,once it is fetched
    useEffect(()=>{
        const count=GetAvgRating(courseData?.data?.courseDetails?.ratingAndReviews)
        setAvgReviewCount(count)
    },[courseData])

    // it will find the total no of lectures of the course
    useEffect(()=>{
        let lectures=0;
    ...
    // this array stores all the opened sections id
    const [isActive, setIsActive] = useState(Array(0))
    // here you need to toggle the section....ie if it is opened then close it,else,open it.
    const handleActive = (id) => {
        // if "isActive" array includes the currently clicked section's id then you need to close it(means remove it from this array)..otherwise,simply add the id to this array
    ...
    const {
        ...
        instructor,
        studentsEnrolled,
        createdAt,} = courseData?.data?.courseDetails
            ...
            <div className={`relative w-full bg-richblack-800`}>
                ...
                <div className="mx-auto box-content px-4 lg:w-[1260px] 2xl:relative ">
                    <div className="mx-auto grid min-h-[450px] max-w-maxContentTab justify-items-center py-8 lg:mx-0 lg:justify-items-start lg:py-0 xl:max-w-[810px]">
                        ...
                        {/* visible only when screen size < lg */}
                        <div className=" lg:hidden relative block max-h-[30rem]">
                    ...
                    <div className="max-w-[830px] ">
                        <div className="flex flex-col gap-3">
                            ...
                            <div className="flex flex-wrap justify-between gap-2">
                                ...
                                <div>
                                    {/* here an array indicates all those sections which are opened...it the array is empty then it means no section is opened yet */}
                                <button className="text-yellow-25" onClick={() => setIsActive([])}>
                                    {/* It will set an empty array, ,means it close all the sections */}
                        ...
                        {/* Now render all the opened and closed sections */}
